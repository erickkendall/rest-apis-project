...
class TagsInStore(MethodView):
    ...
    def post(self, tag_data, store_id):
        # Check unique names in each store
...
class LinkTagsToItem(MethodView):
    ...
    def post(self, item_id, tag_id):
        ...
        try:
            ...
            abort(500, message="Could not link tag to item.")
    ...
    def delete(self, item_id, tag_id):
        ...
        try:
            ...
            abort(500, message="Could not unlink tag to item.")
...
class Users(MethodView):
    ...
    def delete(self):
        ...
        db.session.commit()
        return {"message": "All tags deleted"}, 200